...
impl Serialize for SamplerType {
  fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("SamplerType", self.0 as u32, self.variant_name().unwrap())
  }
}

impl<'de> serde::Deserialize<'de> for SamplerType {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        let s = String::deserialize(deserializer)?;
        for item in SamplerType::ENUM_VALUES {
...
impl Serialize for SeedMode {
  fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("SeedMode", self.0 as u32, self.variant_name().unwrap())
  }
}

impl<'de> serde::Deserialize<'de> for SeedMode {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        let s = String::deserialize(deserializer)?;
        for item in SeedMode::ENUM_VALUES {
            if let Some(item_name) = item.variant_name() {
                if item_name == s {
                    return Ok(item.clone());
                }
...
impl Serialize for ControlMode {
  ...
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("ControlMode", self.0 as u32, self.variant_name().unwrap())
  }
}

impl<'de> serde::Deserialize<'de> for ControlMode {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        let s = String::deserialize(deserializer)?;
        for item in ControlMode::ENUM_VALUES {
            if let Some(item_name) = item.variant_name() {
                if item_name == s {
                    return Ok(item.clone());
                }
...
impl Serialize for ControlInputType {
  fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("ControlInputType", self.0 as u32, self.variant_name().unwrap())
  }
}

impl<'de> serde::Deserialize<'de> for ControlInputType {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        let s = String::deserialize(deserializer)?;
        for item in ControlInputType::ENUM_VALUES {
            if let Some(item_name) = item.variant_name() {
                if item_name == s {
                    return Ok(item.clone());
                }
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown ControlInputType variant: {s}"
        )))
    }
}
...
impl Serialize for LoRAMode {
  fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("LoRAMode", self.0 as u32, self.variant_name().unwrap())
  }
}

impl<'de> serde::Deserialize<'de> for LoRAMode {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        let s = String::deserialize(deserializer)?;
        for item in LoRAMode::ENUM_VALUES {
            if let Some(item_name) = item.variant_name() {
                if item_name == s {
                    return Ok(item.clone());
                }
...
impl Serialize for CompressionMethod {
  ...
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("CompressionMethod", self.0 as u32, self.variant_name().unwrap())
  }
}
...
impl<'de> serde::Deserialize<'de> for CompressionMethod {
    ...
    {
        let s = String::deserialize(deserializer)?;
        for item in CompressionMethod::ENUM_VALUES {
            if let Some(item_name) = item.variant_name() {
                if item_name == s {
                    return Ok(item.clone());
                }
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown CompressionMethod variant: {s}"
        )))
    }
}
...
impl Serialize for ColorCalibration {
  fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
  where
    S: Serializer,
  {
    serializer.serialize_unit_variant("ColorCalibration", self.0 as u32, self.variant_name().unwrap())
  }
}

impl<'de> serde::Deserialize<'de> for ColorCalibration {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        let s = String::deserialize(deserializer)?;
        for item in ColorCalibration::ENUM_VALUES {
            if let Some(item_name) = item.variant_name() {
                if item_name == s {
                    return Ok(item.clone());
                }
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown ColorCalibration variant: {s}"
        )))
    }
}
...
impl Serialize for Control<'_> {
  fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("Control", 10)?;
      if let Some(f) = self.file() {
        s.serialize_field("file", &f)?;
      } else {
        s.skip_field("file")?;
      }
      s.serialize_field("weight", &self.weight())?;
      s.serialize_field("guidance_start", &self.guidance_start())?;
      s.serialize_field("guidance_end", &self.guidance_end())?;
      s.serialize_field("no_prompt", &self.no_prompt())?;
      s.serialize_field("global_average_pooling", &self.global_average_pooling())?;
      s.serialize_field("down_sampling_rate", &self.down_sampling_rate())?;
      s.serialize_field("control_mode", &self.control_mode())?;
      if let Some(f) = self.target_blocks() {
        s.serialize_field("target_blocks", &f)?;
      } else {
        s.skip_field("target_blocks")?;
      }
      s.serialize_field("input_override", &self.input_override())?;
    s.end()
  }
}
...
impl Serialize for LoRA<'_> {
  fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("LoRA", 3)?;
      if let Some(f) = self.file() {
        s.serialize_field("file", &f)?;
      } else {
        s.skip_field("file")?;
...
impl Serialize for GenerationConfiguration<'_> {
  fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("GenerationConfiguration", 88)?;
      s.serialize_field("id", &self.id())?;
      s.serialize_field("start_width", &self.start_width())?;
      s.serialize_field("start_height", &self.start_height())?;
      s.serialize_field("seed", &self.seed())?;
      s.serialize_field("steps", &self.steps())?;
      s.serialize_field("guidance_scale", &self.guidance_scale())?;
      s.serialize_field("strength", &self.strength())?;
      ...
      s.serialize_field("batch_count", &self.batch_count())?;
      s.serialize_field("batch_size", &self.batch_size())?;
      s.serialize_field("hires_fix", &self.hires_fix())?;
      s.serialize_field("hires_fix_start_width", &self.hires_fix_start_width())?;
      s.serialize_field("hires_fix_start_height", &self.hires_fix_start_height())?;
      s.serialize_field("hires_fix_strength", &self.hires_fix_strength())?;
      if let Some(f) = self.upscaler() {
        s.serialize_field("upscaler", &f)?;
      } else {
        s.skip_field("upscaler")?;
      }
      s.serialize_field("image_guidance_scale", &self.image_guidance_scale())?;
      s.serialize_field("seed_mode", &self.seed_mode())?;
      s.serialize_field("clip_skip", &self.clip_skip())?;
      if let Some(f) = self.controls() {
        s.serialize_field("controls", &f)?;
      } else {
        s.skip_field("controls")?;
      }
      if let Some(f) = self.loras() {
        s.serialize_field("loras", &f)?;
      } else {
        s.skip_field("loras")?;
      }
      s.serialize_field("mask_blur", &self.mask_blur())?;
      if let Some(f) = self.face_restoration() {
        s.serialize_field("face_restoration", &f)?;
      } else {
        s.skip_field("face_restoration")?;
      }
      s.serialize_field("clip_weight", &self.clip_weight())?;
      s.serialize_field("negative_prompt_for_image_prior", &self.negative_prompt_for_image_prior())?;
      s.serialize_field("image_prior_steps", &self.image_prior_steps())?;
      if let Some(f) = self.refiner_model() {
        s.serialize_field("refiner_model", &f)?;
      } else {
        s.skip_field("refiner_model")?;
      }
      s.serialize_field("original_image_height", &self.original_image_height())?;
      s.serialize_field("original_image_width", &self.original_image_width())?;
      s.serialize_field("crop_top", &self.crop_top())?;
      s.serialize_field("crop_left", &self.crop_left())?;
      s.serialize_field("target_image_height", &self.target_image_height())?;
      s.serialize_field("target_image_width", &self.target_image_width())?;
      s.serialize_field("aesthetic_score", &self.aesthetic_score())?;
      s.serialize_field("negative_aesthetic_score", &self.negative_aesthetic_score())?;
      s.serialize_field("zero_negative_prompt", &self.zero_negative_prompt())?;
      s.serialize_field("refiner_start", &self.refiner_start())?;
      s.serialize_field("negative_original_image_height", &self.negative_original_image_height())?;
      s.serialize_field("negative_original_image_width", &self.negative_original_image_width())?;
      if let Some(f) = self.name() {
        s.serialize_field("name", &f)?;
      } else {
        s.skip_field("name")?;
      }
      s.serialize_field("fps_id", &self.fps_id())?;
      s.serialize_field("motion_bucket_id", &self.motion_bucket_id())?;
      s.serialize_field("cond_aug", &self.cond_aug())?;
      s.serialize_field("start_frame_cfg", &self.start_frame_cfg())?;
      s.serialize_field("num_frames", &self.num_frames())?;
      s.serialize_field("mask_blur_outset", &self.mask_blur_outset())?;
      s.serialize_field("sharpness", &self.sharpness())?;
      s.serialize_field("shift", &self.shift())?;
      s.serialize_field("stage_2_steps", &self.stage_2_steps())?;
      s.serialize_field("stage_2_cfg", &self.stage_2_cfg())?;
      s.serialize_field("stage_2_shift", &self.stage_2_shift())?;
      s.serialize_field("tiled_decoding", &self.tiled_decoding())?;
      s.serialize_field("decoding_tile_width", &self.decoding_tile_width())?;
      s.serialize_field("decoding_tile_height", &self.decoding_tile_height())?;
      s.serialize_field("decoding_tile_overlap", &self.decoding_tile_overlap())?;
      s.serialize_field("stochastic_sampling_gamma", &self.stochastic_sampling_gamma())?;
      s.serialize_field("preserve_original_after_inpaint", &self.preserve_original_after_inpaint())?;
      s.serialize_field("tiled_diffusion", &self.tiled_diffusion())?;
      s.serialize_field("diffusion_tile_width", &self.diffusion_tile_width())?;
      s.serialize_field("diffusion_tile_height", &self.diffusion_tile_height())?;
      s.serialize_field("diffusion_tile_overlap", &self.diffusion_tile_overlap())?;
      s.serialize_field("upscaler_scale_factor", &self.upscaler_scale_factor())?;
      s.serialize_field("t5_text_encoder", &self.t5_text_encoder())?;
      s.serialize_field("separate_clip_l", &self.separate_clip_l())?;
      if let Some(f) = self.clip_l_text() {
        s.serialize_field("clip_l_text", &f)?;
      } else {
        s.skip_field("clip_l_text")?;
      }
      s.serialize_field("separate_open_clip_g", &self.separate_open_clip_g())?;
      if let Some(f) = self.open_clip_g_text() {
        s.serialize_field("open_clip_g_text", &f)?;
      } else {
        s.skip_field("open_clip_g_text")?;
      }
      s.serialize_field("speed_up_with_guidance_embed", &self.speed_up_with_guidance_embed())?;
      s.serialize_field("guidance_embed", &self.guidance_embed())?;
      s.serialize_field("resolution_dependent_shift", &self.resolution_dependent_shift())?;
      s.serialize_field("tea_cache_start", &self.tea_cache_start())?;
      s.serialize_field("tea_cache_end", &self.tea_cache_end())?;
      s.serialize_field("tea_cache_threshold", &self.tea_cache_threshold())?;
      s.serialize_field("tea_cache", &self.tea_cache())?;
      s.serialize_field("separate_t5", &self.separate_t5())?;
      if let Some(f) = self.t5_text() {
        s.serialize_field("t5_text", &f)?;
      } else {
        s.skip_field("t5_text")?;
      }
      s.serialize_field("tea_cache_max_skip_steps", &self.tea_cache_max_skip_steps())?;
      s.serialize_field("causal_inference_enabled", &self.causal_inference_enabled())?;
      s.serialize_field("causal_inference", &self.causal_inference())?;
      s.serialize_field("causal_inference_pad", &self.causal_inference_pad())?;
      s.serialize_field("cfg_zero_star", &self.cfg_zero_star())?;
      s.serialize_field("cfg_zero_init_steps", &self.cfg_zero_init_steps())?;
      s.serialize_field("compression_artifacts", &self.compression_artifacts())?;
      s.serialize_field("compression_artifacts_quality", &self.compression_artifacts_quality())?;
      s.serialize_field("color_calibration", &self.color_calibration())?;
      s.serialize_field("expand_prompt_to_json", &self.expand_prompt_to_json())?;
    s.end()
  }
}
